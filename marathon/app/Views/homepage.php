        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="intro-message">
                    ...
                    <h3>A Software that Just Runs!</h3>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-5 col-sm-6">
                ...
                <h2 class="section-heading">Race Oversight Made Simple</h2>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
               <h2>Login</h2>
                ...
                echo form_open('http://10.7.66.14/marathon/public/login');
            ...
            <div class="col-sm-5">
                ...
                echo form_open('http://10.7.66.14/marathon/public/create');
                echo form_input('username', '', 'placeholder="Username"') . "<br>";
                echo form_password('password', '', 'placeholder="Password"') . "<br>";
                echo form_password('password2', '', 'placeholder="Confirm Password"') . "<br>";
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-5 col-lg-offset-1 col-sm-push-6  col-sm-6">
                <hr class="section-heading-spacer">
                <div class="clearfix"></div>
                <h2 class="section-heading">Real-Time Tools for Real World Events</h2>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-5 col-sm-6">
                <hr class="section-heading-spacer">
                <div class="clearfix"></div>
                <h2 class="section-heading">Built for any Size Marathon</h2>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <p class="copyright text-muted small">Copyright &copy; Marathon Master 2025. All Rights Reserved</p>
            </div>
        </div>
    </div>
</footer>
